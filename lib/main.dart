        ...
        child: Column(
          ...
          children: <Widget>[
            CircleAvatar(
              radius: 70.0,
              backgroundColor: Colors.grey,
              backgroundImage: AssetImage('images/jr.jpg'),
            ),
            Text(
              'Eduardo L. Barroga Jr.',
              style: TextStyle(
